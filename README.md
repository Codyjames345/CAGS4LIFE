...
- **`CAGS4LIFE-2.3.0-client.zip`** — extract manually into your instance folder (see below)
- **`CAGS4LIFE-2.3.0-curseforge.zip`** — import directly into the CurseForge launcher

### 2. Install it

**Importing the CurseForge zip (easiest):**
1. Open the CurseForge launcher and click **Create Custom Profile** → **Import**.
2. Select `CAGS4LIFE-2.3.0-curseforge.zip` and let it install.
...
3. Extract the contents of `CAGS4LIFE-2.3.0-client.zip` into that folder —
...
───────────────────
  ...
  2.3.0    → Modpack version (e.g. 1.2.0)                     — kept in sync on every build
