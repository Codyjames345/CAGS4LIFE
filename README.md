...
A survival server built around **Create** and tech mods — automate everything, build factories, ride trains, and survive together.
...
1. Create a new **NeoForge 1.21.1** instance.
...
1. Install [NeoForge 1.21.1](https://neoforged.net/) — it will create a new NeoForge profile automatically.
...
Launch NeoForge 1.21.1 and connect to **`cags4.life`**.
